...
**Nexbot** — ultra-lightweight self-hosted ИИ-агент на Go с message bus архитектурой, расширяемыми каналами и навыками. Вдохновлён nanobot, но с чистой архитектурой и фокусом на простоту.
